...
class EnchantmentSeeder extends Seeder<Enchantment> {
  ...
  List<Enchantment> get seeds => [
        ...
        Enchantment(
            ...
            Damage.descrittivo,
            "-   Gittata:Incantatore\n- Componenti:**V, S, M (incenso e una fiala di acqua santa o sacrilega)**\n- Durata:** <inserire durata qui>**\n\nNotice: Undefined variable: duration in /home/customer/www/lawfulorder.it/publichtml/wp-content/plugins/code-snippets/php/snippet-ops.php(470) : eval()'d code on line 8\n\n<br><br>Si prega di completare le informazioni mancanti.<br><br>"),
        Enchantment(
