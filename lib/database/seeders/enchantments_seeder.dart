...
class EnchantmentSeeder extends Seeder<Enchantment> {
  @override
  List<Enchantment> get seeds => [
        Enchantment(
            "Amicizia",
            Level.level0,
            Type.ammaliamento,
        ...
        Enchantment(
            ...
            "",
            Damage.tiroSalvezza,
            "La prossima volta che **l'Incantatore** colpisce con un attacco con un'arma da mischia entro la durata di questo incantesimo, la sua arma vibra di un **rombo di tuono udibile entro 90 metri** e l'attacco infliggerà 2d6 danni da tuono extra al bersaglio.\n\nInoltre, se il bersaglio è una creatura, deve superare un tiro salvezza su Forza, altrimenti è **spinto 3 metri più lontano dall'Incantatore** e buttato a terra **prono**."),
        Enchantment(
            ...
            "",
            Damage.descrittivo,
            "**Tutti** i cibi e le bevande **non magici** entro una **sfera** del **raggio** di **1,5 m** centrata su un **punto** a **scelta dell'Incantatore** entro la **gittata** sono **purificati** e **liberati** dai **veleni** e dalle **malattie**."),
        Enchantment(
            "Raffica di spine",
            Level.level1,
            Type.evocazione,
        ...
        Enchantment(
            ...
            Damage.descrittivo,
            "L'Incantatore descrive o nomina un **tipo specifico di bestia o vegetale**.\n\nConcentrandosi sulla voce della natura che **eccheggia attorno a lui**, apprende la direzione e la distanza fino alla creatura o al vegetale di quel tipo più vicino entro 7,5 km, **se ne è presente almeno uno**."),
        Enchantment(
            "Localizza oggetto",
            Level.level2,
            Type.divinazione,
        ...
        Enchantment(
            ...
            Damage.descrittivo,
            "**L'Incantatore** è avvolto da **un velo d'ombra e di silenzio** che impedisce a lui e ai suoi compagni di essere individuati.\n\nPer la durata dell'incantesimo, **ogni creatura da lui scelta e situata entro 9 metri da lui (incluso sé stesso) ottiene un bonus di +10 alle prove di Destrezza (Furtività) e le sue tracc sono impossibili da seguire se non tramite mezzi magici**.\n\nUna creatura che riceve questo bonus non lascia impronte o altre tracce del suo passaggio."),
        Enchantment(
            "Passo velato",
            Level.level2,
            Type.evocazione,
        ...
        Enchantment(
            ...
            Damage.descrittivo,
            "**L'Incantatore contatta la sua divinità** o un **emissario di quella divinità** e pone fino a **tre domande** a cui sia possibile rispondere **sì o no**.\n\nL'Incantatore deve porre le domande prima che l'incantesimo termini e **riceve la risposta esatta** a ogni domanda.\n\n**Gli esseri divini** non sono necessariamente onniscenti, quindi l'Incantatore potrebbe ricevere **'incerto'** come risposta se una domanda riguarda informazioni che vanno oltre le conoscenze di quella divinità.\n\nNel caso in cui una risposta di una parola possa rivelarsi fuorviante o contraria agli interessi della divinità, il DM può fornire come risposta una breve frase.\n\nSe l'Incantatore lancia l'incantesimo due o più volte prima di completare il suo riposo lungo successivo, esiste una probabilità cumulativa del 25% per ogni lancio dopo il primo **che non ottenga alcuna risposta**. Il DM effettua questo tiro in segreto."),
        Enchantment(
        ...
        Enchantment(
            ...
            true,
            [Component.v, Component.s, Component.m],
            "Sna spada di platino in miniatura dall'impugnatura e dal pomolo di rame e di zinco del valore di 250 mo",
            Damage.attacco,
